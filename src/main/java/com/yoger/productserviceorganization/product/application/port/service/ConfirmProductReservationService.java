...
@Transactional
public class ConfirmProductReservationService implements ConfirmProductReservationUseCase {
    ...
    @Override
    public void confirm(final ConfirmProductReservationCommand command, final String tracingProps) {
    ...
    private void processSuccessfulDeduction(
            final ConfirmProductReservationCommand command,
    ...
    private void publishOrderDeductionSucceededEvent(final ConfirmProductReservationCommand command, final String tracingProps) {
        saveOutboxEventPort.save(
                outboxEventFactory.createOrderDeductionSucceededEvent(command, tracingProps)
        );
    }

    private void publishOrderDeductionFailedEvent(final ConfirmProductReservationCommand command, final String tracingProps) {
        saveOutboxEventPort.save(
